...
class ProfileController {
   ...
   async deleteUser(req: Request, res: Response) {
      const result = await this.profileService.deleteUser(req.user.email);
      res.json(result);
   }
   ...
   async updateProfile(req: Request, res: Response) {
      ...
      const result = await this.profileService.updateUser(email, updateProfileDto);
      res.json(result);
   }
   ...
   async updatePlan(req: Request, res: Response) {
      ...
      const result = await this.profileService.updateCurrentPlan(email, newPlan);
      res.json(result);
   }
}
